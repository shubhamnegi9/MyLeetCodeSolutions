...
public:
    ...
    // Brute Force Approach by checking all subarrays
    // Will give TLE as per constraints
    ...
    int minimumSubarrayLength(vector<int>& nums, int k) {
        // Brute Force Approach by checking all subarrays
        // return minimumSubarrayLength1(nums, k);
        
        // Optimal Approach using Sliding Window
        return minimumSubarrayLength2(nums, k);
    }
};